...
// updating state variable UserDetails
  ...
  const RegisterMedHist =   async (e) =>{
    ...
    <div className="row mt-3">
        ...
        <div className="row mt-3">
            <label>DID:</label>
            <input type="text" className="form-control" id="did" onChange={RegisterInput} name="did" autoComplete="off" required defaultValue={userInfo.status === 1 ? userInfo.UserDetails.did:''} readOnly/>
        </div>
        <div className="row mt-3">
            <label>Gender:</label>
